...
Recall the \emph{complex numbers} $\Ccc$ are a two-dimensional
...
The \emph{quaternions} $\mathscr{Q}$ are a
four-dimensional division ring extension of $\Rrr$.
...
\fix{I need some statement about the conjecture. inspired}
